...
export default function NoticePeriodsGuide() {
    return (
        <>
            <ArticleSchema
                headline="Understanding Rental Notice Periods"
                description="Learn about rental notice periods, how they work, and how to avoid missing important deadlines."
                url="https://rentvault.ai/guides/notice-periods"
            ...
            <BreadcrumbSchema
                items={[
                    ...
                    { name: 'Notice Periods', url: 'https://rentvault.ai/guides/notice-periods' },
                ]}
            />
