...
export default function DepositProtectionGuide() {
    return (
        <>
            <ArticleSchema
                headline="How to Protect Your Rental Deposit"
                description="Learn how to protect your rental deposit with proper documentation. Expert tips on move-in photos, contract review, and avoiding costly deposit disputes."
                url="https://rentvault.ai/guides/deposit-protection"
            ...
            <BreadcrumbSchema
                items={[
                    ...
                    { name: 'Deposit Protection', url: 'https://rentvault.ai/guides/deposit-protection' },
                ]}
            />
