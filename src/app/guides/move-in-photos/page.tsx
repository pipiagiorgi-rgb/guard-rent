...
export default function MoveInPhotosGuide() {
    return (
        <>
            <ArticleSchema
                headline="Why Move-in Photos Matter for Tenants"
                description="Learn why taking photos when you move into a rental is essential for protecting your deposit."
                url="https://rentvault.ai/guides/move-in-photos"
            ...
            <BreadcrumbSchema
                items={[
                    ...
                    { name: 'Move-in Photos', url: 'https://rentvault.ai/guides/move-in-photos' },
                ]}
            />
